...
<head>
    ...
    <link rel="icon" href="#">
    <title>VIJAYALAKSHMI ONLINE FOODS</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> VIJAYALAKSHMI FOODS</a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/main1.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Food & Eat Delicious </h1>
                    <h5 class="font-white space-xs">Find delicious, specials, and order food</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='dishes.php'" type="button" class="btn theme-btn btn-lg">Search food</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Meal</h4> </div>
                        <!-- end:Step -->
