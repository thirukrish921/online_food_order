        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> VIJAYALAKSHMI ONLINE F </a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-6 link-item active"><span>1</span><a href="dishes.php?res_id=48">Pick Your favorite food</a></li>
                        <li class="col-xs-12 col-sm-6 link-item"><span>2</span><a href="#">Order and Pay online</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
            <!-- start: Inner page hero -->
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id=48");
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              Popular  Delicious hot foods! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from dishes where rs_id=48");
									$stmt->execute();
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> VIJAYALAKSHMI ONLINE FOODS </a> <br><span>Order Delivery &amp; Pay </span> </div>
                   
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Srivi Main Road,Near rasi theatre,<br>Reserve Line,<br>Sivakasi-626124</p>
                            <h5>Phone: <a href="tel:+919786920283">+91 9786920283</a></h5>
                              <h5>Email: &nbsp;vijayalashmi@gmail.com</h5></div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>We care for you</h5>
                            <p>We care for your health and enjoy the spicy ever foods..order online...</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
